  ...
  $.fn.TouchSpin = function(options) {
    ...
    return this.each(function() {
      ...
      function upOnce() {
        ...
        settings.current_item_position = (settings.current_item_position+1) % settings.items.length;
        value = settings.items[settings.current_item_position];
      ...
      function downOnce() {
        ...
        settings.current_item_position = settings.current_item_position-1 < 0 ? settings.items.length-1 : settings.current_item_position-1;
        value = settings.items[settings.current_item_position];
